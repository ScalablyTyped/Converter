...
object ContextMenuTriggerProps {
  ...
  implicit class ContextMenuTriggerPropsOps[Self <: ContextMenuTriggerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCollect(collect: /* data */ js.Any => CallbackTo[js.Any]): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        if (collect != null) ret.updateDynamic("collect")(js.Any.fromFunction1((t0: /* data */ js.Any) => collect(t0).runNow()))
        ret.asInstanceOf[Self]
    }
    @scala.inline
