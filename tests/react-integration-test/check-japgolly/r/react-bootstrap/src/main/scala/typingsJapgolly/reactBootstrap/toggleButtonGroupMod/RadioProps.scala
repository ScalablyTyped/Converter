...
object RadioProps {
  ...
  implicit class RadioPropsOps[Self <: RadioProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnChange(value: /* value */ js.Any => Callback): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onChange")(js.Any.fromFunction1((t0: /* value */ js.Any) => value(t0).runNow()))
        ret
    }
    @scala.inline
