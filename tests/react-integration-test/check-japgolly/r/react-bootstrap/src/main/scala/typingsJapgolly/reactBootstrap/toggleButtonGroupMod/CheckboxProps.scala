...
object CheckboxProps {
  ...
  implicit class CheckboxPropsOps[Self <: CheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnChange(value: /* values */ js.Array[js.Any] => Callback): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onChange")(js.Any.fromFunction1((t0: /* values */ js.Array[js.Any]) => value(t0).runNow()))
        ret
    }
    @scala.inline
