...
object CheckboxProps {
  ...
  implicit class CheckboxPropsOps[Self <: CheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnChange(onChange: /* values */ js.Array[js.Any] => Callback): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        if (onChange != null) ret.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* values */ js.Array[js.Any]) => onChange(t0).runNow()))
        ret.asInstanceOf[Self]
    }
    @scala.inline
