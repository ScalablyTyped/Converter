...
object TdHTMLAttributes {
  ...
  implicit class TdHTMLAttributesOps[Self[t] <: TdHTMLAttributes[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withAlign(align: left | center | right | justify | char): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        if (align != null) ret.updateDynamic("align")(align.asInstanceOf[js.Any])
    ...
    @scala.inline
    def withValign(valign: top | middle | bottom | baseline): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        if (valign != null) ret.updateDynamic("valign")(valign.asInstanceOf[js.Any])
        ret.asInstanceOf[Self[T]]
    }
    @scala.inline
