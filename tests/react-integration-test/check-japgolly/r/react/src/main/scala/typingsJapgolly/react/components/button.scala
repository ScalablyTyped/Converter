...
object button {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[HTMLButtonElement with js.Object] {
    @scala.inline
    ...
    @scala.inline
    def onClick(value: ReactMouseEventFrom[HTMLButtonElement] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement]) => value(t0).runNow()))
    @scala.inline
    ...
    @scala.inline
    def `type`(value: submit | reset | typingsJapgolly.react.reactStrings.button): this.type = set("type", value.asInstanceOf[js.Any])
    @scala.inline
