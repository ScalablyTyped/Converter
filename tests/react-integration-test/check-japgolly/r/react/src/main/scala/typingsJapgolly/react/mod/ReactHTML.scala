...
object ReactHTML {
  ...
  implicit class ReactHTMLOps[Self <: ReactHTML] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withData(data: DetailedHTMLFactory[DataHTMLAttributes[Element], Element]): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
    ...
    @scala.inline
    def withDialog(dialog: DetailedHTMLFactory[DialogHTMLAttributes[Element], Element]): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
    ...
    @scala.inline
    def withTd(td: DetailedHTMLFactory[TdHTMLAttributes[Element], Element]): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("td")(td.asInstanceOf[js.Any])
        ret.asInstanceOf[Self]
    }
    @scala.inline
    def withTemplate(template: DetailedHTMLFactory[HTMLAttributes[Element], Element]): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
    ...
    @scala.inline
    def withTh(th: DetailedHTMLFactory[ThHTMLAttributes[Element], Element]): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
    ...
    @scala.inline
    def withWebview(webview: DetailedHTMLFactory[WebViewHTMLAttributes[Element], Element]): Self = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
