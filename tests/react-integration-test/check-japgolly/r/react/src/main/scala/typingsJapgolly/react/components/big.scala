...
object big {
  ...
  implicit def make(companion: big.type): SharedBuilder_DetailedHTMLProps_1760974870[HTMLElement with js.Object] = new SharedBuilder_DetailedHTMLProps_1760974870[HTMLElement with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
