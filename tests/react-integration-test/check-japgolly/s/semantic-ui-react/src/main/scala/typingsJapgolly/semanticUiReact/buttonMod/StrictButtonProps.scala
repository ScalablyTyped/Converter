...
object StrictButtonProps {
  ...
  def apply(
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLButtonElement], t1: /* data */ typingsJapgolly.semanticUiReact.buttonMod.ButtonProps) => onClick(t0, t1).runNow()))
