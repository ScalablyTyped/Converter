...
object abbr {
  ...
  implicit def make(companion: abbr.type): SharedBuilder_DetailedHTMLProps_127198210[HTMLElement] = new SharedBuilder_DetailedHTMLProps_127198210[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
