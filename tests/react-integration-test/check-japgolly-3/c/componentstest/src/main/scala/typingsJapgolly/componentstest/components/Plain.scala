...
object Plain {
  ...
  implicit def make(companion: Plain.type): SharedBuilder_DefaultComponentProps_606679076[HTMLAnchorElement] = new SharedBuilder_DefaultComponentProps_606679076[HTMLAnchorElement](js.Array(this.component, js.Dictionary.empty))()
