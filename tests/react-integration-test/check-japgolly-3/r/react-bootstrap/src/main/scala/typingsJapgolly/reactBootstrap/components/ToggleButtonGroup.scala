...
object ToggleButtonGroup {
  ...
  object CheckboxPropsBasePropsPickButtonGroupPropsHTMLProps {
    ...
    inline def apply(): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[CheckboxProps & BaseProps & Pick & ButtonGroupProps & HTMLProps[typingsJapgolly.reactBootstrap.toggleButtonGroupMod.ToggleButtonGroup]]))
    }
    ...
    def withProps(
      p: CheckboxProps & BaseProps & Pick & ButtonGroupProps & HTMLProps[typingsJapgolly.reactBootstrap.toggleButtonGroupMod.ToggleButtonGroup]
  ...
  object RadioPropsBasePropsPickButtonGroupPropsHTMLProps {
    ...
    inline def apply(name: String): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[RadioProps & BaseProps & Pick & ButtonGroupProps & HTMLProps[typingsJapgolly.reactBootstrap.toggleButtonGroupMod.ToggleButtonGroup]]))
    }
    ...
    def withProps(
      p: RadioProps & BaseProps & Pick & ButtonGroupProps & HTMLProps[typingsJapgolly.reactBootstrap.toggleButtonGroupMod.ToggleButtonGroup]
    ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
