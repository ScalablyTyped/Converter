...
import typingsJapgolly.react.reactSelectMod.ReactSelectProps
import typingsJapgolly.react.reactSelectMod.default
...
object ReactSelect {
  ...
  @JSImport("react/react-select", JSImport.Default)
  @js.native
