...
trait DeprecatedLifecycle[P, S] extends StObject {
  ...
  /**
    ...
    * @see https://reactjs.org/blog/2018/03/27/update-on-async-rendering.html#gradual-migration-path
    */
  var UNSAFE_componentWillReceiveProps: js.UndefOr[js.Function2[/* nextProps */ Readonly[P], /* nextContext */ Any, Unit]] = js.undefined
  ...
  var UNSAFE_componentWillUpdate: js.UndefOr[
    js.Function3[/* nextProps */ Readonly[P], /* nextState */ Readonly[S], /* nextContext */ Any, Unit]
  ] = js.undefined
  ...
  /**
    ...
    * @see https://reactjs.org/blog/2018/03/27/update-on-async-rendering.html#gradual-migration-path
    */
  var componentWillReceiveProps: js.UndefOr[js.Function2[/* nextProps */ Readonly[P], /* nextContext */ Any, Unit]] = js.undefined
...
object DeprecatedLifecycle {
  ...
  implicit open class MutableBuilder[Self <: DeprecatedLifecycle[?, ?], P, S] (val x: Self & (DeprecatedLifecycle[P, S])) extends AnyVal {
    ...
    inline def setComponentWillReceiveProps(value: (/* nextProps */ Readonly[P], /* nextContext */ Any) => Callback): Self = StObject.set(x, "componentWillReceiveProps", js.Any.fromFunction2((t0: /* nextProps */ Readonly[P], t1: /* nextContext */ Any) => (value(t0, t1)).runNow()))
    ...
    inline def setComponentWillUpdate(
      value: (/* nextProps */ Readonly[P], /* nextState */ Readonly[S], /* nextContext */ Any) => Callback
    ): Self = StObject.set(x, "componentWillUpdate", js.Any.fromFunction3((t0: /* nextProps */ Readonly[P], t1: /* nextState */ Readonly[S], t2: /* nextContext */ Any) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setUNSAFE_componentWillReceiveProps(value: (/* nextProps */ Readonly[P], /* nextContext */ Any) => Callback): Self = StObject.set(x, "UNSAFE_componentWillReceiveProps", js.Any.fromFunction2((t0: /* nextProps */ Readonly[P], t1: /* nextContext */ Any) => (value(t0, t1)).runNow()))
    ...
    inline def setUNSAFE_componentWillUpdate(
      value: (/* nextProps */ Readonly[P], /* nextState */ Readonly[S], /* nextContext */ Any) => Callback
    ): Self = StObject.set(x, "UNSAFE_componentWillUpdate", js.Any.fromFunction3((t0: /* nextProps */ Readonly[P], t1: /* nextState */ Readonly[S], t2: /* nextContext */ Any) => (value(t0, t1, t2)).runNow()))
