...
object reactContextmenuMod {
  ...
  object ContextMenuProps {
    ...
    implicit open class MutableBuilder[Self <: ContextMenuProps] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction3((t0: /* event */ MouseEvent, t1: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Object */ /* data */ Any, t2: /* target */ HTMLElement) => (value(t0, t1, t2)).runNow()))
  ...
  object MenuItemProps {
    ...
    implicit open class MutableBuilder[Self <: MenuItemProps] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "onClick", js.Any.fromFunction3((t0: /* event */ TouchEvent | MouseEvent, t1: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Object */ /* data */ Any, t2: /* target */ HTMLElement) => (value(t0, t1, t2)).runNow()))
