...
object article {
  ...
  implicit def make(companion: article.type): SharedBuilder_DetailedHTMLProps_364684144[HTMLElement] = new SharedBuilder_DetailedHTMLProps_364684144[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
