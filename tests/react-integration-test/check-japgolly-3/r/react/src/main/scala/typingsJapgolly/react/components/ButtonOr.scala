...
object ButtonOr {
  ...
  implicit def make(companion: ButtonOr.type): SharedBuilder_ButtonOrProps2121472179 = new SharedBuilder_ButtonOrProps2121472179(js.Array(this.component, js.Dictionary.empty))()
