...
import typingsJapgolly.react.reactContextmenuMod.ContextMenuTriggerProps
...
object ContextMenuTrigger {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.react.reactContextmenuMod.ContextMenuTrigger] {
