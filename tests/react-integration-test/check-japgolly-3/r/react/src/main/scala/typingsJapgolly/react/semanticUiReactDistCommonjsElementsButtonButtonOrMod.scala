...
object semanticUiReactDistCommonjsElementsButtonButtonOrMod extends Shortcut {
  
  @JSImport("react/semantic-ui-react/dist/commonjs/elements/Button/ButtonOr", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `semanticUiReactDistCommonjsElementsButtonButtonOrMod.foo` */
