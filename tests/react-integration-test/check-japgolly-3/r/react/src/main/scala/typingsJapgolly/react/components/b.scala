...
object b {
  ...
  implicit def make(companion: b.type): SharedBuilder_DetailedHTMLProps_19736828[HTMLElement] = new SharedBuilder_DetailedHTMLProps_19736828[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
