...
object abbr {
  ...
  implicit def make(companion: abbr.type): SharedBuilder_DetailedHTMLProps_364684144[HTMLElement] = new SharedBuilder_DetailedHTMLProps_364684144[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
