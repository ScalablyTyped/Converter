...
import typingsJapgolly.react.reactBootstrapLibButtonGroupMod.ButtonGroupProps
...
object ButtonGroup {
  ...
  @JSImport("react/react-bootstrap/lib/ButtonGroup", JSImport.Namespace)
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onAbort(
      value: ReactEventFrom[
          (japgolly.scalajs.react.facade.React.Component[ButtonGroupProps & js.Object, js.Object]) & Element
        ] => Callback
