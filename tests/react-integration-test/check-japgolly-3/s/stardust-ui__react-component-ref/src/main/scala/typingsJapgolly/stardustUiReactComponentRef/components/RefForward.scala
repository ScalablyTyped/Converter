...
object RefForward {
  ...
  implicit def make(companion: RefForward.type): SharedBuilder_RefProps618491947[default] = new SharedBuilder_RefProps618491947[default](js.Array(this.component, js.Dictionary.empty))()
