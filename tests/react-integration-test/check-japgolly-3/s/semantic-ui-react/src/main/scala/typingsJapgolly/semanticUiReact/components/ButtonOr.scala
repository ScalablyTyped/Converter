...
object ButtonOr {
  ...
  implicit def make(companion: ButtonOr.type): SharedBuilder_ButtonOrProps_1316981655 = new SharedBuilder_ButtonOrProps_1316981655(js.Array(this.component, js.Dictionary.empty))()
