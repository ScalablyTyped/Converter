...
import _root_.typingsJapgolly.react.mod.ComponentClass
...
import _root_.typingsJapgolly.semanticUiReact.distCommonjsModulesAccordionAccordionAccordionMod.StrictAccordionAccordionProps
