...
object AccordionContent {
  ...
  implicit def make(companion: AccordionContent.type): SharedBuilder_AccordionContentProps964070972 = new SharedBuilder_AccordionContentProps964070972(js.Array(this.component, js.Dictionary.empty))()
