...
object ButtonContent {
  ...
  implicit def make(companion: ButtonContent.type): SharedBuilder_ButtonContentProps_1283954424 = new SharedBuilder_ButtonContentProps_1283954424(js.Array(this.component, js.Dictionary.empty))()
