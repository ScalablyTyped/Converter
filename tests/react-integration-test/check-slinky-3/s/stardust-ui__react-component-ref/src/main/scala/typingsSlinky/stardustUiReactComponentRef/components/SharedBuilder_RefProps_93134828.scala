...
@scala.inline
open class SharedBuilder_RefProps_93134828[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
     with StBuildingComponent[tag.type, R] {
  
  inline def innerRef(value: _root_.typingsSlinky.react.mod.Ref[Any]): this.type = set("innerRef", value.asInstanceOf[js.Any])
