...
object AccordionContent {
  ...
  implicit def make(companion: AccordionContent.type): SharedBuilder_AccordionContentProps102150083 = new SharedBuilder_AccordionContentProps102150083(js.Array(this.component, js.Dictionary.empty))()
