...
object Button {
  ...
  object Content {
    ...
    implicit def make(companion: Content.type): SharedBuilder_ButtonContentProps2140108940 = new SharedBuilder_ButtonContentProps2140108940(js.Array(this.component, js.Dictionary.empty))()
  ...
  object Group {
    ...
    implicit def make(companion: Group.type): SharedBuilder_ButtonGroupProps_138423406 = new SharedBuilder_ButtonGroupProps_138423406(js.Array(this.component, js.Dictionary.empty))()
  ...
  object Or {
    ...
    implicit def make(companion: Or.type): SharedBuilder_ButtonOrProps1435030884 = new SharedBuilder_ButtonOrProps1435030884(js.Array(this.component, js.Dictionary.empty))()
