...
object Inline {
  ...
  implicit def make(companion: Inline.type): SharedBuilder_DefaultComponentProps988386800[HTMLAnchorElement] = new SharedBuilder_DefaultComponentProps988386800[HTMLAnchorElement](js.Array(this.component, js.Dictionary.empty))()
