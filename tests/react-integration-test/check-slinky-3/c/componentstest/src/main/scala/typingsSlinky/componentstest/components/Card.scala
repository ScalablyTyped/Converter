...
object Card {
  ...
  object Grid2 {
    ...
    implicit def make(companion: Grid2.type): SharedBuilder_CardGridProps392342402 = new SharedBuilder_CardGridProps392342402(js.Array(this.component, js.Dictionary.empty))()
