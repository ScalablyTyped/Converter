...
object DeprecatedLifecycle {
  ...
  implicit open class MutableBuilder[Self <: DeprecatedLifecycle[?, ?], P, S] (val x: Self & (DeprecatedLifecycle[P, S])) extends AnyVal {
    ...
    inline def setComponentWillReceiveProps(value: (/* nextProps */ Readonly[P], /* nextContext */ Any) => Unit): Self = StObject.set(x, "componentWillReceiveProps", js.Any.fromFunction2(value))
    
    inline def setComponentWillReceivePropsUndefined: Self = StObject.set(x, "componentWillReceiveProps", js.undefined)
    
    inline def setComponentWillUpdate(value: (/* nextProps */ Readonly[P], /* nextState */ Readonly[S], /* nextContext */ Any) => Unit): Self = StObject.set(x, "componentWillUpdate", js.Any.fromFunction3(value))
    ...
    inline def setUNSAFE_componentWillReceiveProps(value: (/* nextProps */ Readonly[P], /* nextContext */ Any) => Unit): Self = StObject.set(x, "UNSAFE_componentWillReceiveProps", js.Any.fromFunction2(value))
    ...
    inline def setUNSAFE_componentWillUpdate(value: (/* nextProps */ Readonly[P], /* nextState */ Readonly[S], /* nextContext */ Any) => Unit): Self = StObject.set(x, "UNSAFE_componentWillUpdate", js.Any.fromFunction3(value))
