...
object ButtonContent {
  ...
  implicit def make(companion: ButtonContent.type): SharedBuilder_ButtonContentProps_1651054347 = new SharedBuilder_ButtonContentProps_1651054347(js.Array(this.component, js.Dictionary.empty))()
