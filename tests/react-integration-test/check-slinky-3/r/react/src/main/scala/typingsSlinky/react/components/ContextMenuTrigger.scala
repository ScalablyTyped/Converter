...
import typingsSlinky.react.reactContextmenuMod.ContextMenuTriggerProps
...
object ContextMenuTrigger {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.react.reactContextmenuMod.ContextMenuTrigger] {
