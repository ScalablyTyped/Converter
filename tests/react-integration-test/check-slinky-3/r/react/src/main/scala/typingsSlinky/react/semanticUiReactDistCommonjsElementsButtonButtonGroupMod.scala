...
object semanticUiReactDistCommonjsElementsButtonButtonGroupMod extends Shortcut {
  
  @JSImport("react/semantic-ui-react/dist/commonjs/elements/Button/ButtonGroup", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `semanticUiReactDistCommonjsElementsButtonButtonGroupMod.foo` */
