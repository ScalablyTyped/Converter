...
object b {
  ...
  implicit def make(companion: b.type): SharedBuilder_DetailedHTMLProps2003142551[HTMLElement] = new SharedBuilder_DetailedHTMLProps2003142551[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
