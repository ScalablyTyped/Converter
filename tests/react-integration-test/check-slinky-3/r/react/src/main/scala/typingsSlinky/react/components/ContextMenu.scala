...
import typingsSlinky.react.reactContextmenuMod.ContextMenuProps
...
object ContextMenu {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.react.reactContextmenuMod.ContextMenu] {
    ...
    inline def onMouseLeaveFunction3(
      value: (/* event */ MouseEvent, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Object */ /* data */ Any, /* target */ HTMLElement) => Unit
