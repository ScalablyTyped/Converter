...
object componentstestMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.react.componentstestMod.A
    - typingsSlinky.react.componentstestMod.B
  */
  trait Props extends StObject
  object Props {
    
    inline def A(aCallback: () => Double, aMember: Double): typingsSlinky.react.componentstestMod.A = {
      val __obj = js.Dynamic.literal(aCallback = js.Any.fromFunction0(aCallback), aMember = aMember.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.react.componentstestMod.A]
    }
    
    inline def B(bMember: String): typingsSlinky.react.componentstestMod.B = {
      val __obj = js.Dynamic.literal(bMember = bMember.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.react.componentstestMod.B]
    }
  }
}
