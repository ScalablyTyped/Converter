...
import typingsSlinky.react.reactBootstrapLibButtonGroupMod.ButtonGroupProps
...
object ButtonGroup {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.react.reactBootstrapMod.ButtonGroup] {
