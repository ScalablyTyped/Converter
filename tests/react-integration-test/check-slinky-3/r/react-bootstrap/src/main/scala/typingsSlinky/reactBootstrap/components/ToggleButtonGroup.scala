...
object ToggleButtonGroup {
  ...
  object CheckboxPropsBasePropsPickButtonGroupPropsHTMLProps {
    ...
    inline def apply(): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[CheckboxProps & BaseProps & Pick & ButtonGroupProps & HTMLProps[typingsSlinky.reactBootstrap.toggleButtonGroupMod.ToggleButtonGroup]]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[tag.type, typingsSlinky.reactBootstrap.mod.ToggleButtonGroup] {
    ...
    def withProps(
      p: CheckboxProps & BaseProps & Pick & ButtonGroupProps & HTMLProps[typingsSlinky.reactBootstrap.toggleButtonGroupMod.ToggleButtonGroup]
  ...
  object RadioPropsBasePropsPickButtonGroupPropsHTMLProps {
    ...
    inline def apply(name: String): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[RadioProps & BaseProps & Pick & ButtonGroupProps & HTMLProps[typingsSlinky.reactBootstrap.toggleButtonGroupMod.ToggleButtonGroup]]))
    }
    ...
    def withProps(
      p: RadioProps & BaseProps & Pick & ButtonGroupProps & HTMLProps[typingsSlinky.reactBootstrap.toggleButtonGroupMod.ToggleButtonGroup]
    ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
