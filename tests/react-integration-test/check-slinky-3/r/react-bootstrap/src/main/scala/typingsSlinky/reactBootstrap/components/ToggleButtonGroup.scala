...
import _root_.typingsSlinky.reactBootstrap.libToggleButtonGroupMod.BaseProps
import _root_.typingsSlinky.reactBootstrap.libToggleButtonGroupMod.CheckboxProps
import _root_.typingsSlinky.reactBootstrap.libToggleButtonGroupMod.RadioProps
...
object ToggleButtonGroup {
  ...
  object CheckboxPropsBasePropsButtonGroupPropsHTMLProps {
    ...
    open class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[tag.type, _root_.typingsSlinky.reactBootstrap.mod.ToggleButtonGroup] {
