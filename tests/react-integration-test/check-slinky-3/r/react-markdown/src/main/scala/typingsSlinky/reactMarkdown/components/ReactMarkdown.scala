...
/* The props of this component has an unsupported shape. You can use `set` manually to use it, but with no compiler support :/ . Couldn't find props for typingsSlinky.reactMarkdown.mod.ReactMarkdownProps because: IArray(Couldn't find props for typingsSlinky.reactMarkdown.mod.ChildrenProp & "Not" & js.Any because: IArray(Could't extract props from "Not" because couldn't resolve ClassTree.), IArray(Could't extract props from js.Any because couldn't resolve ClassTree.), Couldn't find props for typingsSlinky.reactMarkdown.mod.SourceProp & "Not" & js.Any because: IArray(Could't extract props from "Not" because couldn't resolve ClassTree.), IArray(Could't extract props from js.Any because couldn't resolve ClassTree.)) */
