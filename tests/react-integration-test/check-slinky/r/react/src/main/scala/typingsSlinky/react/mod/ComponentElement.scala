...
object ComponentElement {
  ...
  @scala.inline
  implicit class ComponentElementOps[Self[p, t /* <: typingsSlinky.react.mod.Component[P, typingsSlinky.react.mod.ComponentState, _] */] <: ComponentElement[p, t], P, T] (val x: Self[P, T]) extends AnyVal {
    @scala.inline
