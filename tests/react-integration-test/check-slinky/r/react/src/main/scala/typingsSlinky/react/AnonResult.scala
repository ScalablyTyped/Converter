...
object AnonResult {
  ...
  @scala.inline
  implicit class AnonResultOps[Self[t /* <: typingsSlinky.react.mod.ComponentType[_] */] <: AnonResult[t], T <: ReactComponentClass[_]] (val x: Self[T]) extends AnyVal {
    @scala.inline
    def duplicate: Self[T] = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self[T]]
    @scala.inline
    def combineWith[Other /* <: js.Any */](other: Other): Self[T] with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self[T] with Other]
    @scala.inline
    def with_result(_result: T): Self[T] = {
        val ret = this.duplicate.asInstanceOf[js.Dynamic]
        ret.updateDynamic("_result")(_result.asInstanceOf[js.Any])
