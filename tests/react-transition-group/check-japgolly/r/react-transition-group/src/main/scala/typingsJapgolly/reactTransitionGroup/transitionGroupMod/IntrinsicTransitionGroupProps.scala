...
object IntrinsicTransitionGroupProps {
  ...
  @scala.inline
  implicit class IntrinsicTransitionGroupPropsOps[Self[t /* <: typingsJapgolly.reactTransitionGroup.reactTransitionGroupStrings.abbr | typingsJapgolly.reactTransitionGroup.reactTransitionGroupStrings.animate */] <: IntrinsicTransitionGroupProps[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
