...
object ComponentTransitionGroupProps {
  ...
  @scala.inline
  implicit class ComponentTransitionGroupPropsOps[Self[t /* <: typingsSlinky.react.mod.ReactType[_] */] <: ComponentTransitionGroupProps[t], T <: ReactComponentClass[_]] (val x: Self[T]) extends AnyVal {
    @scala.inline
