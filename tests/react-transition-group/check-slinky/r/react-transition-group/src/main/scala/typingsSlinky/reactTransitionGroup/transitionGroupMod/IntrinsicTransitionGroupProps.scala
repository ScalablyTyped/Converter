...
object IntrinsicTransitionGroupProps {
  ...
  @scala.inline
  implicit class IntrinsicTransitionGroupPropsOps[Self[t /* <: typingsSlinky.reactTransitionGroup.reactTransitionGroupStrings.abbr | typingsSlinky.reactTransitionGroup.reactTransitionGroupStrings.animate */] <: IntrinsicTransitionGroupProps[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
