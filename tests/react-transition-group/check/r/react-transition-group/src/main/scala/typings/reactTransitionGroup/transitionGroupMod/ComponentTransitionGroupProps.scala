...
object ComponentTransitionGroupProps {
  ...
  @scala.inline
  implicit class ComponentTransitionGroupPropsOps[Self[t /* <: typings.react.mod.ReactType[_] */] <: ComponentTransitionGroupProps[t], T <: ReactType[_]] (val x: Self[T]) extends AnyVal {
    @scala.inline
