...
object libButtonButtonMod extends Shortcut {
  ...
  - typings.antd.libButtonButtonMod.MergedHTMLAttributes because var conflicts: children, disabled. Inlined formAction, target, onClick, ping, value, formMethod, media, formEncType, formNoValidate, formTarget, dangerouslySetInnerHTML, defaultChecked, name, form, referrerPolicy, download, href, hrefLang */ trait ButtonProps
    extends StObject
  ...
  /* This means you don't have to write `default`, but can instead just say `libButtonButtonMod.foo` */
