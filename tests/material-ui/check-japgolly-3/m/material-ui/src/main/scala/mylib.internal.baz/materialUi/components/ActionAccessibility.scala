...
private[internal] object ActionAccessibility {
  ...
  implicit def make(companion: ActionAccessibility.type): SharedBuilder_Object_159303587[
    _root_.mylib.internal.baz.materialUi.svgIconsActionAccessibilityMod.ActionAccessibility
