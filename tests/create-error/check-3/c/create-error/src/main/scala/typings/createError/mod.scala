...
object mod {
  ...
  inline def apply[T /* <: Error[Error[js.Error]] */](Target: Error[Error[js.Error]], name: String, properties: js.Any): T = (^.asInstanceOf[js.Dynamic].apply(Target.asInstanceOf[js.Any], name.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def apply[T /* <: Error[Error[js.Error]] */](Target: Error[Error[js.Error]], name: Unit, properties: js.Any): T = (^.asInstanceOf[js.Dynamic].apply(Target.asInstanceOf[js.Any], name.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def apply[T /* <: Error[Error[js.Error]] */](name: String, properties: js.Any): T = (^.asInstanceOf[js.Dynamic].apply(name.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[T]
