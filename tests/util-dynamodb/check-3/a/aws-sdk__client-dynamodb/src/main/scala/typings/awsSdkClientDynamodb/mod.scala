...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.awsSdkClientDynamodb.mod.AttributeValue.BMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.BOOLMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.BSMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.LMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.MMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.NMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.NSMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.NULLMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.SMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.SSMember
    - typings.awsSdkClientDynamodb.mod.AttributeValue.UnknownMember
  */
