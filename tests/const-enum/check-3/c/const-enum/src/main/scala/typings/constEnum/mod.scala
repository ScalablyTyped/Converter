...
object mod {
  ...
  inline def foo_1(x: 1 | "C"): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("foo")(x.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  object PreOrderHookFlags {
    ...
    inline def NumberOfInitHooksCalledMask: Int = 4294901760.0.asInstanceOf[Int]
    
    inline def NumberOfInitHooksCalledShift: 16 = 16.asInstanceOf[16]
  }
  type PreOrderHookFlags = 65535 | 65536 | 16 | Int
}
