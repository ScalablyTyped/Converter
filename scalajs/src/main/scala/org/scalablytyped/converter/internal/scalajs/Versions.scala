...
//        "-Yexplicit-nulls"
  ...
  val slinkyWeb    = Dep.ScalaJs("me.shadaj", "slinky-web", "0.6.8+10-ca6379d6")
  val slinkyNative = Dep.ScalaJs("me.shadaj", "slinky-native", "0.6.8+10-ca6379d6").for3Use2_13(scala.is3)
