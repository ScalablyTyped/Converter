...
import org.scalablytyped.converter.internal.scalajs.flavours.CastConversion.{TParam, TypeRewriterCast}
...
object JapgollyTypeConversions {
  def apply(reactNames: ReactNames, scalaJsDomNames: ScalaJsDomNames): TypeRewriterCast = {
