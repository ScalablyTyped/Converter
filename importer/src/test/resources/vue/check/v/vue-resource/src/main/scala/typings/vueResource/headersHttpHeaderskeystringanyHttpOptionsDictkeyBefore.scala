...
@js.native
trait headersHttpHeaderskeystringanyHttpOptionsDictkeyBefore
...
object headersHttpHeaderskeystringanyHttpOptionsDictkeyBefore {
  @scala.inline
  def apply(
    ...
    url: String = null
  ): headersHttpHeaderskeystringanyHttpOptionsDictkeyBefore = {
    ...
    __obj.asInstanceOf[headersHttpHeaderskeystringanyHttpOptionsDictkeyBefore]
  }
}
