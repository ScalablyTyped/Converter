...
trait HttpInterceptor extends js.Object {
  var request: UndefOr[js.Function1[/* request */ HttpOptions, HttpOptions]] = js.undefined
  var response: UndefOr[js.Function1[/* response */ HttpResponse, HttpResponse]] = js.undefined
}
