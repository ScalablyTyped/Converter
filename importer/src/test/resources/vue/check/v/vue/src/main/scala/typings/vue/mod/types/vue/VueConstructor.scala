...
import typings.vue.mod.types.options.DirectiveFunction
import typings.vue.mod.types.options.DirectiveOptions
import typings.vue.mod.types.options.FunctionalComponentOptions
import typings.vue.mod.types.options.PropsDefinition
import typings.vue.mod.types.options.RecordPropsDefinition
import typings.vue.mod.types.options.ThisTypedComponentOptionsWithArrayProps
import typings.vue.mod.types.options.ThisTypedComponentOptionsWithRecordProps
import typings.vue.mod.types.plugin.PluginFunction
import typings.vue.mod.types.plugin.PluginObject
