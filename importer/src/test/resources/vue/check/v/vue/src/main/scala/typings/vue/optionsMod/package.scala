...
package object optionsMod {
  ...
  import typings.vue.AnonArgs
  import typings.vue.AnonDefault
  ...
  type InjectOptions = (StringDictionary[InjectKey | AnonDefault]) | js.Array[String]
  type Prop[T] = js.Function0[T] | AnonArgs[T]
