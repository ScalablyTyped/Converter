...
trait ComponentOptions[V /* <: vueLib.vueVueMod.Vue */, Data, Methods, Computed, PropsDef] extends js.Object {
  ...
  var `extends`: js.UndefOr[
    ...
    ]) | vueLib.vueVueMod.VueConstructor[vueLib.vueVueMod.Vue]
  ] = js.undefined
  ...
  var parent: js.UndefOr[vueLib.vueVueMod.Vue] = js.undefined
  ...
  var render: js.UndefOr[
    js.Function1[/* createElement */ vueLib.vueVueMod.CreateElement, vueLib.vnodeMod.VNode]
  ] = js.undefined
  var renderError: js.UndefOr[
    js.Function2[
      /* h */ js.Function0[vueLib.vnodeMod.VNode], 
      /* err */ stdLib.Error, 
