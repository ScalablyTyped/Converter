...
ScalablyTyped.runtime.Instantiable0[
  ...
  def component[PropNames /* <: java.lang.String */](
    id: java.lang.String,
    definition: VueLib.VueTypesOptionsModule.FunctionalComponentOptions[StdLib.Record[PropNames, _], js.Array[PropNames]]
  ): ExtendedVue[V, js.Object, js.Object, js.Object, StdLib.Record[PropNames, _]] = js.native
  def component[Data, Methods, Computed, Props](
    id: java.lang.String,
    definition: VueLib.VueTypesOptionsModule.AsyncComponent[Data, Methods, Computed, Props]
  ...
  def component_DataMethodsComputedPropNamesString[Data, Methods, Computed, PropNames /* <: java.lang.String */](
    id: java.lang.String,
    definition: VueLib.VueTypesOptionsModule.ThisTypedComponentOptionsWithArrayProps[V, Data, Methods, Computed, PropNames]
  ...
  def component_DataMethodsComputedProps[Data, Methods, Computed, Props](
    id: java.lang.String,
    definition: VueLib.VueTypesOptionsModule.ThisTypedComponentOptionsWithRecordProps[V, Data, Methods, Computed, Props]
  ): ExtendedVue[V, Data, Methods, Computed, Props] = js.native
  @JSName("component")
