...
trait CreateElement extends js.Object {
  def apply(): VueLib.VueTypesVnodeModule.VNode = js.native
  def apply(tag: VueLib.VueTypesOptionsModule.AsyncComponent[_, _, _, _]): VueLib.VueTypesVnodeModule.VNode = js.native
  def apply(tag: VueLib.VueTypesOptionsModule.AsyncComponent[_, _, _, _], children: VueLib.VueTypesVnodeModule.VNodeChildren): VueLib.VueTypesVnodeModule.VNode = js.native
  def apply(tag: VueLib.VueTypesOptionsModule.AsyncComponent[_, _, _, _], data: VueLib.VueTypesVnodeModule.VNodeData): VueLib.VueTypesVnodeModule.VNode = js.native
  def apply(tag: VueLib.VueTypesOptionsModule.AsyncComponent[_, _, _, _], data: VueLib.VueTypesVnodeModule.VNodeData, children: VueLib.VueTypesVnodeModule.VNodeChildren): VueLib.VueTypesVnodeModule.VNode = js.native
  def apply(tag: VueLib.VueTypesOptionsModule.Component[_, _, _, _]): VueLib.VueTypesVnodeModule.VNode = js.native
  def apply(tag: VueLib.VueTypesOptionsModule.Component[_, _, _, _], children: VueLib.VueTypesVnodeModule.VNodeChildren): VueLib.VueTypesVnodeModule.VNode = js.native
  def apply(tag: VueLib.VueTypesOptionsModule.Component[_, _, _, _], data: VueLib.VueTypesVnodeModule.VNodeData): VueLib.VueTypesVnodeModule.VNode = js.native
  def apply(tag: VueLib.VueTypesOptionsModule.Component[_, _, _, _], data: VueLib.VueTypesVnodeModule.VNodeData, children: VueLib.VueTypesVnodeModule.VNodeChildren): VueLib.VueTypesVnodeModule.VNode = js.native
  def apply(tag: java.lang.String): VueLib.VueTypesVnodeModule.VNode = js.native
