...
package object VueTypesOptionsModule {
  ...
  type DirectiveFunction = js.Function4[
    ...
    /* binding */ VueLib.VueTypesVnodeModule.VNodeDirective, 
    /* vnode */ VueLib.VueTypesVnodeModule.VNode, 
    /* oldVnode */ VueLib.VueTypesVnodeModule.VNode, 
    scala.Unit
  ]
  ...
  type ThisTypedComponentOptionsWithRecordProps[V /* <: VueLib.VueTypesVueModule.Vue */, Data, Methods, Computed, Props] = js.Object with (ComponentOptions[
    V, 
    ...
    VueLib.VueTypesVueModule.CombinedVueInstance[V, Data, Methods, Computed, StdLib.Readonly[Props]]
  ])
