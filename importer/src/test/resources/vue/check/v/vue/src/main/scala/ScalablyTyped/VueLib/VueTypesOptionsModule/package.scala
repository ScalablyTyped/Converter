...
package object VueTypesOptionsModule {
  ...
  type ThisTypedComponentOptionsWithArrayProps[V /* <: VueLib.VueTypesVueModule.Vue */, Data, Methods, Computed, PropNames /* <: java.lang.String */] = js.Object with (ComponentOptions[V, Data | (js.ThisFunction0[/* this */ (StdLib.Readonly[StdLib.Record[PropNames, _]]) with V, Data]), Methods, Computed, StdLib.Array[PropNames]]) with (StdLib.ThisType[VueLib.VueTypesVueModule.CombinedVueInstance[V, Data, Methods, Computed, StdLib.Readonly[StdLib.Record[PropNames, _]]]])
  type ThisTypedComponentOptionsWithRecordProps[V /* <: VueLib.VueTypesVueModule.Vue */, Data, Methods, Computed, Props] = js.Object with (ComponentOptions[V, Data | (js.ThisFunction0[/* this */ StdLib.Readonly[Props] with V, Data]), Methods, Computed, RecordPropsDefinition[Props]]) with (StdLib.ThisType[VueLib.VueTypesVueModule.CombinedVueInstance[V, Data, Methods, Computed, StdLib.Readonly[Props]]])
