...
object ComponentOptions {
  @scala.inline
  def apply[V /* <: vueLib.typesVueMod.Vue */, Data, Methods, Computed, PropsDef](
    ...
    errorCaptured: () => scala.Boolean | scala.Unit = null,
    ...
    render: /* createElement */ vueLib.typesVueMod.CreateElement => vueLib.typesVnodeMod.VNode = null,
    renderError: (/* h */ js.Function0[vueLib.typesVnodeMod.VNode], /* err */ stdLib.Error) => vueLib.typesVnodeMod.VNode = null,
