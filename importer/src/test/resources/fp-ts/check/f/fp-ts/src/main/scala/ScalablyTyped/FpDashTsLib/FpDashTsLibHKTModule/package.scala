...
package object FpDashTsLibHKTModule {
  type Type[URI /* <: URIS */, A] = /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(fp-ts), TsIdentModule(None,List(fp-ts, lib, HKT)), TsIdentSimple(URI2HKT))),List(TsTypeRef(TsQIdent(List(TsIdentSimple(A))),List()))),Left(TsIdentSimple(URI))) */js.Any
