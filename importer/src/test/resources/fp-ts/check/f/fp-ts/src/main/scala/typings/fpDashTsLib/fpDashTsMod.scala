...
import typings.fpDashTsLib.fpDashTsLibStrings.Either
...
object fpDashTsMod extends js.Object {
  ...
  object taskNs extends js.Object {
    def tryCatch[L, A](f: js.Any, onrejected: js.Function1[/* reason */ js.Object, L]): typings.fpDashTsLib.libEitherMod.Either[L, A] = js.native
  }
