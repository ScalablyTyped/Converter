package typingsJapgolly.atStardustDashUiReactDashComponentDashEventDashListener.distEsTypesMod
...
object EventListenerOptions {
  ...
  def apply[T /* <: EventTypes */](
    listener: /* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify DocumentEventMap * / any[T] */ /* e */ js.Any => Callback,
    targetRef: RefHandle[
      /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Node */ js.Any
    ],
    `type`: T,
    ...
    __obj.updateDynamic("listener")(js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify DocumentEventMap * / any[T] */ /* e */ js.Any) => listener(t0).runNow()))
