...
import typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Input.Input.InputOnChangeData
import typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Input.Input.InputProps
import typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Input.default
import typingsJapgolly.semanticUiReact.mod.dist.commonjs.generic.HtmlInputrops
...
object ModDistCommonjsElementsInput {
  def apply(
    about: String = null,
    accept: String = null,
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement], t1: /* data */ typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Input.Input.InputOnChangeData) => onChange(t0, t1).runNow()))
  ...
  typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Input.Input.InputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Input.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Input.Input.InputProps])(children: _*)
  }
