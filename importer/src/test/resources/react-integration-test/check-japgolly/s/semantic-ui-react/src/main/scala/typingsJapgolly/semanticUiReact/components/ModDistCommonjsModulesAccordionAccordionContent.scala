...
object ModDistCommonjsModulesAccordionAccordionContent {
  ...
  typingsJapgolly.semanticUiReact.mod.dist.commonjs.modules.Accordion.AccordionContent.AccordionContentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.mod.dist.commonjs.modules.Accordion.AccordionContent.AccordionContentProps])(children: _*)
  }
