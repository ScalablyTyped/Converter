...
import typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Button.Button.ButtonProps
import typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Button.default
import typingsJapgolly.semanticUiReact.mod.dist.commonjs.generic.SemanticCOLORS
import typingsJapgolly.semanticUiReact.mod.dist.commonjs.generic.SemanticFLOATS
import typingsJapgolly.semanticUiReact.mod.dist.commonjs.generic.SemanticSIZES
...
object ModDistCommonjsElementsButton {
  def apply(
    about: String = null,
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLButtonElement], t1: /* data */ typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Button.Button.ButtonProps) => onClick(t0, t1).runNow()))
  ...
  typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Button.Button.ButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Button.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.mod.dist.commonjs.elements.Button.Button.ButtonProps])(children: _*)
  }
