...
import typingsJapgolly.reactContextmenu.mod.ContextMenu
import typingsJapgolly.reactContextmenu.mod.ContextMenuProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ModContextMenu {
  def apply(
    id: String,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ContextMenuProps, ContextMenu, Unit, ContextMenuProps] = {
  ...
  typingsJapgolly.reactContextmenu.mod.ContextMenuProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactContextmenu.mod.ContextMenu](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactContextmenu.mod.ContextMenuProps])(children: _*)
  }
