...
import typingsSlinky.semanticUiReact.mod.dist.commonjs.elements.Button.Button.ButtonProps
import typingsSlinky.semanticUiReact.mod.dist.commonjs.elements.Button.ButtonGroup.ButtonGroupProps
...
abstract class SharedApply_ButtonGroupProps_608994122 () {
