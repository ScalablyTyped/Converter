...
object SemanticWIDTHSNUMBER {
  ...
  @scala.inline
  def `12`: typingsSlinky.semanticUiReact.semanticUiReactNumbers.`12` = this.cast(12)
  @scala.inline
  ...
  @scala.inline
  def `16`: typingsSlinky.semanticUiReact.semanticUiReactNumbers.`16` = this.cast(16)
  @scala.inline
  ...
  @scala.inline
  def `4`: typingsSlinky.semanticUiReact.semanticUiReactNumbers.`4` = this.cast(4)
  @scala.inline
  def `5`: typingsSlinky.semanticUiReact.semanticUiReactNumbers.`5` = this.cast(5)
  @scala.inline
  ...
  @scala.inline
  def `8`: typingsSlinky.semanticUiReact.semanticUiReactNumbers.`8` = this.cast(8)
  @scala.inline
