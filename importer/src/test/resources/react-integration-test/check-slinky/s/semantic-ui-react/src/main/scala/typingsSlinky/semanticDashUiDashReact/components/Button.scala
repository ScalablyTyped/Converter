...
object Button
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.semanticDashUiDashReact.srcElementsButtonMod.default].asInstanceOf[String | js.Object]
  def apply(
    about: String = null,
