package typingsSlinky.semanticUiReact.mod.dist.commonjs.elements.Button
...
@js.native
class default ()
  extends typingsSlinky.semanticUiReact.mod.dist.commonjs.elements.Button.Button.default
