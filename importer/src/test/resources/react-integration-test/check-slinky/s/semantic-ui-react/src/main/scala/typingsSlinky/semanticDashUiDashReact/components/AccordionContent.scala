...
object AccordionContent
  ...
  override val component: String | js.Object = typingsSlinky.semanticDashUiDashReact.srcModulesAccordionAccordionContentMod.default.asInstanceOf[String | js.Object]
  def apply(
