...
abstract class SharedApply_RefProps723810627 () {
  ...
  val raw: Raw
  def apply(innerRef: Ref[_] = null, _overrides: StringDictionary[js.Any] = null): BuildingComponent[tag.type, js.Object] = {
