...
import typingsSlinky.reactContextmenu.mod.MenuItem
...
object ModMenuItem {
  object raw
    extends ExternalComponentWithAttributesWithRefType[tag.type, MenuItem] {
  ...
  ): BuildingComponent[tag.type, MenuItem] = {
