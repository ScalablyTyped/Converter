...
import typingsSlinky.reactContextmenu.mod.ContextMenu
...
object ModContextMenu {
  object raw
    extends ExternalComponentWithAttributesWithRefType[tag.type, ContextMenu] {
  ...
  ): BuildingComponent[tag.type, ContextMenu] = {
