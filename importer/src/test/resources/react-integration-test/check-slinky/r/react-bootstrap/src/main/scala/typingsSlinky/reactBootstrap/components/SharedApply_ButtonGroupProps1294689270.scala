...
import typingsSlinky.reactBootstrap.mod.lib.ButtonGroup.ButtonGroup
import typingsSlinky.reactBootstrap.mod.lib.ButtonGroup.ButtonGroupProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_ButtonGroupProps1294689270[ComponentRef <: js.Object] () {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[ButtonGroup] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with ButtonGroup, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with ButtonGroup, Event] => Unit = null,
