...
import typingsSlinky.reactBootstrap.mod.ToggleButtonGroup
...
object ModToggleButtonGroup {
  object raw
    extends ExternalComponentWithAttributesWithRefType[tag.type, ToggleButtonGroup] {
  ...
  def apply(props: ToggleButtonGroupProps with js.Object, _overrides: StringDictionary[js.Any] = null): BuildingComponent[tag.type, ToggleButtonGroup] = {
