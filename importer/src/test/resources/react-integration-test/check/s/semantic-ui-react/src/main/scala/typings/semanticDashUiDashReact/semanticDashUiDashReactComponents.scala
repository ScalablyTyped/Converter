...
object semanticDashUiDashReactComponents extends semanticDashUiDashReactProps {
  ...
  @scala.inline
  def TestContainer: ComponentType[TestContainerProps] = typings.semanticDashUiDashReact.distCommonjsElementsTestContainerMod.default.asInstanceOf[typings.react.reactMod.ComponentType[TestContainerProps]]
}
