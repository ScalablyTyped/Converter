package typings.semanticUiReact.mod.dist.commonjs.elements.Button.Button
...
import typings.semanticUiReact.mod.dist.commonjs.generic.SemanticShorthandItem
