package typingsJapgolly.reactContextmenu.reactContextmenuMod
...
class ContextMenu protected ()
  extends Component[ContextMenuProps, ComponentState, js.Any] {
...
@JSImport("react-contextmenu", "ContextMenu")
@js.native
object ContextMenu extends TopLevel[ComponentClass[ContextMenuProps, ComponentState]]
