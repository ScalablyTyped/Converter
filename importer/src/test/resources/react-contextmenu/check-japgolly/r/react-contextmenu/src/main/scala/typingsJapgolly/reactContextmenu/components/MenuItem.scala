...
import typingsJapgolly.reactContextmenu.reactContextmenuMod.MenuItemProps
...
object MenuItem {
  def apply(
    ...
    MenuItemProps, 
    typingsJapgolly.reactContextmenu.reactContextmenuMod.MenuItem, 
    Unit, 
    MenuItemProps
  ] = {
  ...
  typingsJapgolly.reactContextmenu.reactContextmenuMod.MenuItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactContextmenu.reactContextmenuMod.MenuItem](js.constructorOf[typingsJapgolly.reactContextmenu.reactContextmenuMod.MenuItem])
    f(__obj.asInstanceOf[typingsJapgolly.reactContextmenu.reactContextmenuMod.MenuItemProps])(children: _*)
  }
}
