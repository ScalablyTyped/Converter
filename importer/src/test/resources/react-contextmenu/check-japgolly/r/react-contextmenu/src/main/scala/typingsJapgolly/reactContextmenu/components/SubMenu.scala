...
import typingsJapgolly.reactContextmenu.reactContextmenuMod.SubMenuProps
...
object SubMenu {
  def apply(
    ...
    SubMenuProps, 
    typingsJapgolly.reactContextmenu.reactContextmenuMod.SubMenu, 
    Unit, 
    SubMenuProps
  ] = {
  ...
  typingsJapgolly.reactContextmenu.reactContextmenuMod.SubMenuProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactContextmenu.reactContextmenuMod.SubMenu](js.constructorOf[typingsJapgolly.reactContextmenu.reactContextmenuMod.SubMenu])
    f(__obj.asInstanceOf[typingsJapgolly.reactContextmenu.reactContextmenuMod.SubMenuProps])(children: _*)
  }
}
