...
import typings.reactDropzone.typingsReactDropzoneMod.DropEvent
import typings.reactDropzone.typingsReactDropzoneMod.DropzoneState
...
object ReactDropzone {
  def apply(
    ...
    children: js.UndefOr[/* state */ DropzoneState => CallbackTo[Element]]
  ): UnmountedWithRoot[
    ...
    getFilesFromEvent.foreach(p => __obj.updateDynamic("getFilesFromEvent")(js.Any.fromFunction1(((t0: /* event */ typings.reactDropzone.typingsReactDropzoneMod.DropEvent) => p(t0).runNow()))))
  ...
  /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify File */ js.Any], t2: /* event */ typings.reactDropzone.typingsReactDropzoneMod.DropEvent) => p(t0, t1, t2).runNow()))))
    onDropAccepted.foreach(p => __obj.updateDynamic("onDropAccepted")(js.Any.fromFunction2(((t0: /* files */ js.Array[
  /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify File */ js.Any], t1: /* event */ typings.reactDropzone.typingsReactDropzoneMod.DropEvent) => p(t0, t1).runNow()))))
  ...
  japgolly.scalajs.react.raw.React.Ref](typings.reactDropzone.typingsReactDropzoneMod.default)
    f(__obj.asInstanceOf[typings.reactDropzone.DropzonePropsRefAttributesDropzoneRef])(japgolly.scalajs.react.vdom.VdomNode.cast(children))
  }
}
