package typings.reactDropzone.Slinky
...
object ReactDropzone
  ...
  override val component: String | js.Object = typings.reactDropzone.typingsReactDropzoneMod.default.asInstanceOf[String | js.Object]
  def apply(
