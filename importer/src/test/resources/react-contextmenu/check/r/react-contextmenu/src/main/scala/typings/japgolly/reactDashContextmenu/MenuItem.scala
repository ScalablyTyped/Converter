...
object MenuItem {
  def apply(
    ...
    MenuItemProps, 
    typings.reactDashContextmenu.reactDashContextmenuMod.MenuItem, 
    Unit, 
    MenuItemProps
  ] = {
  ...
  typings.reactDashContextmenu.reactDashContextmenuMod.MenuItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typings.reactDashContextmenu.reactDashContextmenuMod.MenuItem](js.constructorOf[typings.reactDashContextmenu.reactDashContextmenuMod.MenuItem])
    f(__obj.asInstanceOf[typings.reactDashContextmenu.reactDashContextmenuMod.MenuItemProps])(children: _*)
  }
}
