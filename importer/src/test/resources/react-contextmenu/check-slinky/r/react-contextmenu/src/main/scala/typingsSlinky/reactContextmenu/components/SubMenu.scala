...
import typingsSlinky.reactContextmenu.reactContextmenuMod.SubMenuProps
...
object SubMenu
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactContextmenu.reactContextmenuMod.SubMenu] {
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactContextmenu.reactContextmenuMod.SubMenu].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactContextmenu.reactContextmenuMod.SubMenu] = {
