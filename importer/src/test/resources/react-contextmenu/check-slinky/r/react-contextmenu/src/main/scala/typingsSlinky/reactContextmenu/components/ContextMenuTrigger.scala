...
import typingsSlinky.reactContextmenu.reactContextmenuMod.ContextMenuTriggerProps
...
object ContextMenuTrigger
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactContextmenu.reactContextmenuMod.ContextMenuTrigger] {
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactContextmenu.reactContextmenuMod.ContextMenuTrigger].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactContextmenu.reactContextmenuMod.ContextMenuTrigger] = {
