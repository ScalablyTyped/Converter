...
package object ReactNamespace {
  type DOMFactory[P /* <: DOMAttributes[T] */, T /* <: ReactLib.Element */] = js.Function2[/* props */ js.UndefOr[ClassAttributes[T] with (P | scala.Null)], /* repeated */ReactNode, DOMElement[P, T]]
