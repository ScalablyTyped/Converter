...
import typingsJapgolly.reactBootstrap.reactBootstrapMod.Sizes
...
object ButtonGroup {
  def apply(
    ...
    ButtonGroupProps, 
    typingsJapgolly.reactBootstrap.libMod.ButtonGroup, 
    Unit, 
    ButtonGroupProps
  ] = {
  ...
  typingsJapgolly.reactBootstrap.libButtonGroupMod.ButtonGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactBootstrap.libMod.ButtonGroup](js.constructorOf[typingsJapgolly.reactBootstrap.libMod.ButtonGroup])
    f(__obj.asInstanceOf[typingsJapgolly.reactBootstrap.libButtonGroupMod.ButtonGroupProps])(children: _*)
  }
}
