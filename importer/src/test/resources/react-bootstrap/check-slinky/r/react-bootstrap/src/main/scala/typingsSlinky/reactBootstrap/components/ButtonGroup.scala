...
import typingsSlinky.reactBootstrap.reactBootstrapMod.Sizes
...
object ButtonGroup
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBootstrap.libMod.ButtonGroup] {
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactBootstrap.libMod.ButtonGroup].asInstanceOf[String | js.Object]
  def apply(
    defaultValue: foo,
    onChange: foo,
    value: foo,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBootstrap.libMod.ButtonGroup] = {
