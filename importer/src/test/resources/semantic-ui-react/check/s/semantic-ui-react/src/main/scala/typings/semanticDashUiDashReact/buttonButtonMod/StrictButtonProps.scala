package typings.semanticDashUiDashReact.buttonButtonMod
...
trait StrictButtonProps extends js.Object {
  ...
  var color: js.UndefOr[
    (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify SemanticCOLORS */ js.Any) | facebook | (`google plus`) | vk | twitter | linkedin | instagram | youtube
  ] = js.undefined
  ...
  var floated: js.UndefOr[
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify SemanticFLOATS */ js.Any
  ] = js.undefined
  /** A button can take the width of its container. */
  var fluid: js.UndefOr[Boolean] = js.undefined
  /** Add an Icon by name, props object, or pass an <Icon />. */
  var icon: js.UndefOr[
    Boolean | (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify SemanticShorthandItem<IconProps> */ js.Any)
  ] = js.undefined
  /** A button can be formatted to appear on dark backgrounds. */
  var inverted: js.UndefOr[Boolean] = js.undefined
  /** Add a Label by text, props object, or pass a <Label />. */
  var label: js.UndefOr[
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify SemanticShorthandItem<LabelProps> */ js.Any
  ] = js.undefined
  ...
  var onClick: js.UndefOr[
    js.Function2[
      /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify React.MouseEvent<HTMLButtonElement> */ /* event */ js.Any, 
      /* data */ ButtonProps, 
      Unit
    ]
  ] = js.undefined
  ...
  var size: js.UndefOr[
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify SemanticSIZES */ js.Any
  ] = js.undefined
...
object StrictButtonProps {
  ...
  def apply(
    ...
    onClick: (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify React.MouseEvent<HTMLButtonElement> */ /* event */ js.Any, /* data */ ButtonProps) => Unit = null,
