...
import typings.semanticUiReact.elementsListListMod.ListProps
...
object List {
  def apply(
    ...
    if (onItemClick != null) __obj.updateDynamic("onItemClick")(js.Any.fromFunction2(((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLAnchorElement], t1: /* data */ typings.semanticUiReact.elementsListListItemMod.ListItemProps) => onItemClick(t0, t1).runNow())))
  ...
  typings.semanticUiReact.elementsListListMod.ListProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](typings.semanticUiReact.elementsListMod.default)
    f(__obj.asInstanceOf[typings.semanticUiReact.elementsListListMod.ListProps])(children: _*)
  }
}
