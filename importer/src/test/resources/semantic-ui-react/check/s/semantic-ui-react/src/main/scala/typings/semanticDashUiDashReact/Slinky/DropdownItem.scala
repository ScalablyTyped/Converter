...
object DropdownItem
  ...
  override val component: String | js.Object = js.constructorOf[typings.semanticDashUiDashReact.srcModulesDropdownDropdownItemMod.default].asInstanceOf[String | js.Object]
  def apply(
