...
object DropdownSearchInput
  ...
  override val component: String | js.Object = js.constructorOf[typings.semanticUiReact.modulesDropdownDropdownSearchInputMod.default].asInstanceOf[String | js.Object]
  def apply(
