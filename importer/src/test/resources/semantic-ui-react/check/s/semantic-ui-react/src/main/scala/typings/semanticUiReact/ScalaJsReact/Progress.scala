...
object Progress {
  ...
  typings.semanticUiReact.modulesProgressProgressMod.ProgressProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typings.semanticUiReact.modulesProgressMod.default](js.constructorOf[typings.semanticUiReact.modulesProgressMod.default])
    f(__obj.asInstanceOf[typings.semanticUiReact.modulesProgressProgressMod.ProgressProps])(children: _*)
  }
}
