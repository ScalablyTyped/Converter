...
import typings.semanticUiReact.elementsLabelMod.default
...
object Label {
  def apply(
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2(((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement], t1: /* data */ typings.semanticUiReact.elementsLabelLabelMod.LabelProps) => onClick(t0, t1).runNow())))
    if (onRemove != null) __obj.updateDynamic("onRemove")(js.Any.fromFunction2(((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement], t1: /* data */ typings.semanticUiReact.elementsLabelLabelMod.LabelProps) => onRemove(t0, t1).runNow())))
  ...
  typings.semanticUiReact.elementsLabelLabelMod.LabelProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typings.semanticUiReact.elementsLabelMod.default](js.constructorOf[typings.semanticUiReact.elementsLabelMod.default])
    f(__obj.asInstanceOf[typings.semanticUiReact.elementsLabelLabelMod.LabelProps])(children: _*)
  }
}
