...
object Input {
  ...
  ChildArg*
    ...
    if (!js.isUndefined(loading)) __obj.updateDynamic("loading")(loading)
        if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2(((t0: /* event */ typings.react.reactMod.ChangeEvent[typings.react.HTMLInputElement], t1: /* data */ typings.semanticDashUiDashReact.srcElementsInputInputMod.InputOnChangeData) => onChange(t0, t1).runNow())))
