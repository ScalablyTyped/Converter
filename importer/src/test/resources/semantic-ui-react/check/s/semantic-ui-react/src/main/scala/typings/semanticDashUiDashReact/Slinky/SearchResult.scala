...
object SearchResult
  ...
  override val component: String | js.Object = js.constructorOf[typings.semanticDashUiDashReact.srcModulesSearchSearchResultMod.default].asInstanceOf[String | js.Object]
  def apply(
