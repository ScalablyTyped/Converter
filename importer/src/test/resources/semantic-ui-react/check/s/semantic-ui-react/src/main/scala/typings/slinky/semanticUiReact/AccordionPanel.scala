...
object AccordionPanel
  ...
  override val component: String | js.Object = js.constructorOf[typings.semanticUiReact.modulesAccordionAccordionPanelMod.default].asInstanceOf[String | js.Object]
  def apply(
