package typings.semanticDashUiDashReact.elementsButtonButtonGroupMod
...
trait StrictButtonGroupProps extends js.Object {
  ...
  var buttons: js.UndefOr[
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify SemanticShorthandCollection<ButtonProps> */ js.Any
  ] = js.undefined
  /** Primary content. */
  ...
  var color: js.UndefOr[
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify SemanticCOLORS */ js.Any
  ] = js.undefined
  ...
  var widths: js.UndefOr[
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify SemanticWIDTHS */ js.Any
  ] = js.undefined
}
