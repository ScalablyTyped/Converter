...
object Inner
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.semanticUiReact.modulesDimmerMod.default.Inner] {
  override val component: String | js.Object = js.constructorOf[typings.semanticUiReact.modulesDimmerMod.default.Inner].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.semanticUiReact.modulesDimmerMod.default.Inner] = {
