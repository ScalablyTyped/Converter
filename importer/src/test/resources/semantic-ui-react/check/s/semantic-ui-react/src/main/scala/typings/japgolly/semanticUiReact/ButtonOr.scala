package typings.japgolly.semanticUiReact
...
object ButtonOr {
  ...
  js.Object](typings.semanticUiReact.elementsButtonButtonOrMod.default)
    f(__obj.asInstanceOf[typings.semanticUiReact.elementsButtonButtonOrMod.ButtonOrProps])(children: _*)
  }
}
