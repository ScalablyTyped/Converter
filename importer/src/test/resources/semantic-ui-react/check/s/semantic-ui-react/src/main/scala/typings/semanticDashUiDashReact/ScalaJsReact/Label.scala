...
object Label {
  ...
  ChildArg*
    ...
    if (image != null) __obj.updateDynamic("image")(image)
        if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2(((t0: /* event */ typings.react.reactMod.MouseEvent[typings.react.HTMLElement, typings.react.NativeMouseEvent], t1: /* data */ typings.semanticDashUiDashReact.srcElementsLabelLabelMod.LabelProps) => onClick(t0, t1).runNow())))
        if (onRemove != null) __obj.updateDynamic("onRemove")(js.Any.fromFunction2(((t0: /* event */ typings.react.reactMod.MouseEvent[typings.react.HTMLElement, typings.react.NativeMouseEvent], t1: /* data */ typings.semanticDashUiDashReact.srcElementsLabelLabelMod.LabelProps) => onRemove(t0, t1).runNow())))
