...
object Label {
  def apply(
    ...
    if (image != null) __obj.updateDynamic("image")(image)
        if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2(((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement], t1: /* data */ typings.semanticDashUiDashReact.srcElementsLabelLabelMod.LabelProps) => onClick(t0, t1).runNow())))
        if (onRemove != null) __obj.updateDynamic("onRemove")(js.Any.fromFunction2(((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement], t1: /* data */ typings.semanticDashUiDashReact.srcElementsLabelLabelMod.LabelProps) => onRemove(t0, t1).runNow())))
