...
object Inner {
  ...
  ChildArg*
    ...
    type InnerType = typings.semanticDashUiDashReact.srcModulesDimmerMod.default.Inner
    ...
    val f = JsForwardRefComponent.force[Props, Children.Varargs, InnerType](js.constructorOf[InnerType])
