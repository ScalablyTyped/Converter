...
object ButtonContent {
  ...
  ChildArg*
    ...
    type ButtonContentType = scala.scalajs.js.Object
    ...
    val f = JsForwardRefComponent.force[Props, Children.Varargs, ButtonContentType](js.constructorOf[ButtonContentType])
