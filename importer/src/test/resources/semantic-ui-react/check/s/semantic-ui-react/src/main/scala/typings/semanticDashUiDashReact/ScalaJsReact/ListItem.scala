...
object ListItem {
  ...
  ChildArg*
    ...
    if (image != null) __obj.updateDynamic("image")(image.asInstanceOf[js.Any])
        if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2(((t0: /* event */ typings.react.reactMod.MouseEvent[typings.react.HTMLAnchorElement, typings.react.NativeMouseEvent], t1: /* data */ typings.semanticDashUiDashReact.srcElementsListListItemMod.ListItemProps) => onClick(t0, t1).runNow())))
