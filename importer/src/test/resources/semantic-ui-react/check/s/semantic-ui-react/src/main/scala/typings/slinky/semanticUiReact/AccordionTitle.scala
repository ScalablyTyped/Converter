package typings.slinky.semanticUiReact
...
object AccordionTitle
  ...
  override val component: String | js.Object = js.constructorOf[typings.semanticUiReact.modulesAccordionAccordionTitleMod.default].asInstanceOf[String | js.Object]
  def apply(
