...
object TransitionGroup
  ...
  override val component: String | js.Object = js.constructorOf[typings.semanticUiReact.modulesTransitionTransitionGroupMod.default].asInstanceOf[String | js.Object]
  def apply(
