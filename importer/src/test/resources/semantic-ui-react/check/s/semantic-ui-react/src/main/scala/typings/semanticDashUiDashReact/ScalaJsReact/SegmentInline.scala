...
object SegmentInline {
  ...
  ChildArg*
    ...
    type SegmentInlineType = scala.scalajs.js.Object
    ...
    val f = JsForwardRefComponent.force[Props, Children.Varargs, SegmentInlineType](js.constructorOf[SegmentInlineType])
