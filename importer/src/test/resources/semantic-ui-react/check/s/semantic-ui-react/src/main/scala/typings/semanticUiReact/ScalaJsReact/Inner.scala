...
object Inner {
  def apply(
    ...
    DimmerInnerProps, 
    typings.semanticUiReact.modulesDimmerMod.default.Inner, 
    Unit, 
    DimmerInnerProps
  ] = {
  ...
  typings.semanticUiReact.modulesDimmerMod.default.Inner](js.constructorOf[typings.semanticUiReact.modulesDimmerMod.default.Inner])
