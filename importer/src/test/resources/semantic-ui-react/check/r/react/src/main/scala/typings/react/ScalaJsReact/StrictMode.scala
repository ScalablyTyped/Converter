...
object StrictMode {
  def apply()(children: ChildArg*): UnmountedSimple[
    ...
    val f = japgolly.scalajs.react.JsComponent[typings.react.Anon_Children, japgolly.scalajs.react.Children.Varargs, js.Object](typings.react.reactMod.StrictMode)
