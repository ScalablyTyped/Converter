...
import typingsJapgolly.semanticUiReact.elementsTestContainerTestContainerMod.TestContainerProps
...
object TestContainer {
  def apply(
    ...
    optFn1Number.foreach(x => __obj.updateDynamic("optFn1Number")(js.Any.fromFunction1((t0: /* x */ scala.Double) => x(t0).runNow())))
    optFn1Void.foreach(x => __obj.updateDynamic("optFn1Void")(js.Any.fromFunction1((t0: /* x */ scala.Double) => x(t0).runNow())))
  ...
  typingsJapgolly.semanticUiReact.elementsTestContainerTestContainerMod.TestContainerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](typingsJapgolly.semanticUiReact.elementsTestContainerMod.default)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.elementsTestContainerTestContainerMod.TestContainerProps])(children: _*)
  }
}
