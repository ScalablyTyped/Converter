package typings.semanticUiReact.elementsInputInputMod
...
object StrictInputProps {
  ...
  def apply(
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement], t1: /* data */ typings.semanticUiReact.elementsInputInputMod.InputOnChangeData) => onChange(t0, t1).runNow()))
