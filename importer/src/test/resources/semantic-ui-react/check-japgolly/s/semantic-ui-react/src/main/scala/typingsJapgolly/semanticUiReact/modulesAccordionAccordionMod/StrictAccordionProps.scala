package typingsJapgolly.semanticUiReact.modulesAccordionAccordionMod
...
import typingsJapgolly.semanticUiReact.modulesAccordionAccordionAccordionMod.StrictAccordionAccordionProps
