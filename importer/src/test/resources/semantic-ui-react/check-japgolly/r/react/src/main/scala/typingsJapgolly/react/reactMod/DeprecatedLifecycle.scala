...
object DeprecatedLifecycle {
  ...
  def apply[P, S](
    ...
    UNSAFE_componentWillReceiveProps.foreach(x => __obj.updateDynamic("UNSAFE_componentWillReceiveProps")(js.Any.fromFunction2((t0: /* nextProps */ P, t1: /* nextContext */ js.Any) => x(t0, t1).runNow())))
    UNSAFE_componentWillUpdate.foreach(x => __obj.updateDynamic("UNSAFE_componentWillUpdate")(js.Any.fromFunction3((t0: /* nextProps */ P, t1: /* nextState */ S, t2: /* nextContext */ js.Any) => x(t0, t1, t2).runNow())))
    componentWillMount.foreach(p => __obj.updateDynamic("componentWillMount")(p.toJsFn))
    componentWillReceiveProps.foreach(x => __obj.updateDynamic("componentWillReceiveProps")(js.Any.fromFunction2((t0: /* nextProps */ P, t1: /* nextContext */ js.Any) => x(t0, t1).runNow())))
    componentWillUpdate.foreach(x => __obj.updateDynamic("componentWillUpdate")(js.Any.fromFunction3((t0: /* nextProps */ P, t1: /* nextState */ S, t2: /* nextContext */ js.Any) => x(t0, t1, t2).runNow())))
