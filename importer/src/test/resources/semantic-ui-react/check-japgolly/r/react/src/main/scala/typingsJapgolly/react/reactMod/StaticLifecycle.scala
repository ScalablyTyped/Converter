...
object StaticLifecycle {
  ...
  def apply[P, S](
    ...
    getDerivedStateFromError.foreach(x => __obj.updateDynamic("getDerivedStateFromError")(js.Any.fromFunction1((t0: /* error */ js.Any) => x(t0).runNow())))
    getDerivedStateFromProps.foreach(x => __obj.updateDynamic("getDerivedStateFromProps")(js.Any.fromFunction2((t0: P, t1: S) => x(t0, t1).runNow())))
