...
object createElement extends js.Object {
  ...
  def apply[P /* <: js.Object */](`type`: String, props: Attributes with P, children: ReactNode*): slinky.core.facade.ReactElement = js.native
  ...
  def apply[P /* <: js.Object */](`type`: ComponentClass[P, ComponentState], props: Attributes with P, children: ReactNode*): slinky.core.facade.ReactElement = js.native
  // Custom components
  ...
  def apply[P /* <: DOMAttributes[T] */, T /* <: Element */](`type`: String, props: ClassAttributes[T] with P, children: ReactNode*): slinky.core.facade.ReactElement = js.native
  ...
  def apply[P /* <: js.Object */, T /* <: ReactComponentClass[P] */, C /* <: ReactComponentClass[P] */](`type`: ClassType[P, T, C], props: ClassAttributes[T] with P, children: ReactNode*): CElement[P, T] = js.native
}
