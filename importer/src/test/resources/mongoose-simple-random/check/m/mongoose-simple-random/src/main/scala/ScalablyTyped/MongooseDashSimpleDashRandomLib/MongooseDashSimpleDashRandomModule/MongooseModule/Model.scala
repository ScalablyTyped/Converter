...
package MongooseDashSimpleDashRandomLib.MongooseDashSimpleDashRandomModule.MongooseModule
...
@js.native
trait Model[T /* <: MongooseLib.MongooseModule.Document */]
  extends NodeLib.NodeJSNamespace.EventEmitter
     with MongooseLib.MongooseModule.ModelProperties {
  ...
  def findRandom(
    ...
    options: js.Object,
    callback: js.Function2[/* err */ js.Any, /* res */ js.UndefOr[StdLib.Array[T]], scala.Unit]
