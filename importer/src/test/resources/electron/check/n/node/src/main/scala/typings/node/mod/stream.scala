...
object stream extends js.Object {
  ...
  - typings.node.mod.stream.Stream because Already inherited
  - typings.node.mod.stream.Writable because Inheritance from two classes. Inlined writable, emit, emit, end, end, end */ @js.native
