...
object DynamoDBNamespace extends js.Object {
  @js.native
  class Converter () extends AwsDashSdkLib.AwsDashSdkClientsDynamodbModule.Converter
  
  @js.native
  class DocumentClient () extends AwsDashSdkLib.AwsDashSdkClientsDynamodbModule.DocumentClient {
    /**
  ...
  @js.native
  class Types () extends AwsDashSdkLib.AwsDashSdkClientsDynamodbModule.Types {
