...
@JSImport("aws-sdk", Namespace)
@js.native
object awsDashSdkMod extends js.Object {
  @js.native
  class DynamoDB () extends typings.awsDashSdk.clientsAllMod.DynamoDB {
  ...
  object DynamoDB extends js.Object {
    @js.native
    class Converter () extends typings.awsDashSdk.clientsAllMod.DynamoDB.Converter
    
    @js.native
    /**
      * Creates a DynamoDB document client with a set of configuration options.
      */
    class DocumentClient () extends typings.awsDashSdk.clientsAllMod.DynamoDB.DocumentClient {
