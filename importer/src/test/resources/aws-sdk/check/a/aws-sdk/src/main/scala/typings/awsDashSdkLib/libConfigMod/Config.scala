package typings.awsDashSdkLib.libConfigMod

import typings.awsDashSdkLib.libConfigUnderscoreServiceUnderscorePlaceholdersMod.ConfigurationServicePlaceholders
