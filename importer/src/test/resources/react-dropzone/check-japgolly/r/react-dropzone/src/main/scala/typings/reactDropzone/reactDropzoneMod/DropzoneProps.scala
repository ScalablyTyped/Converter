package typings.reactDropzone.reactDropzoneMod
...
object DropzoneProps {
  ...
  def apply(
    ...
    if (children != null) __obj.updateDynamic("children")(js.Any.fromFunction1((t0: /* state */ typings.reactDropzone.reactDropzoneMod.DropzoneState) => children(t0).runNow()))
    if (!js.isUndefined(disabled)) __obj.updateDynamic("disabled")(disabled.asInstanceOf[js.Any])
    if (getFilesFromEvent != null) __obj.updateDynamic("getFilesFromEvent")(js.Any.fromFunction1((t0: /* event */ typings.reactDropzone.reactDropzoneMod.DropEvent) => getFilesFromEvent(t0).runNow()))
    ...
    if (onDrop != null) __obj.updateDynamic("onDrop")(js.Any.fromFunction3((t0: /* acceptedFiles */ js.Array[js.Any], t1: /* rejectedFiles */ js.Array[js.Any], t2: /* event */ typings.reactDropzone.reactDropzoneMod.DropEvent) => onDrop(t0, t1, t2).runNow()))
    if (onDropAccepted != null) __obj.updateDynamic("onDropAccepted")(js.Any.fromFunction2((t0: /* files */ js.Array[js.Any], t1: /* event */ typings.reactDropzone.reactDropzoneMod.DropEvent) => onDropAccepted(t0, t1).runNow()))
    if (onDropRejected != null) __obj.updateDynamic("onDropRejected")(js.Any.fromFunction2((t0: /* files */ js.Array[js.Any], t1: /* event */ typings.reactDropzone.reactDropzoneMod.DropEvent) => onDropRejected(t0, t1).runNow()))
