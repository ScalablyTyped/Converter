...
object DropzoneInputProps {
  ...
  def apply(
    ...
    onChange.foreach(p => __obj.updateDynamic("onChange")(js.Any.fromFunction1(((t0: japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement]) => p(t0).runNow()))))
