...
object ComponentLifecycle {
  ...
  def apply[P, S, SS](
    ...
    componentDidUpdate.foreach(x => __obj.updateDynamic("componentDidUpdate")(js.Any.fromFunction3((t0: P, t1: S, t2: /* snapshot */ js.UndefOr[SS]) => x(t0, t1, t2).runNow())))
    ...
    shouldComponentUpdate.foreach(x => __obj.updateDynamic("shouldComponentUpdate")(js.Any.fromFunction3((t0: /* nextProps */ P, t1: /* nextState */ S, t2: /* nextContext */ js.Any) => x(t0, t1, t2).runNow())))
