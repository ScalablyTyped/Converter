...
@js.native
trait Anon_ByteLength extends ScalablyTyped.runtime.Instantiable2[/* str */ java.lang.String, /* encoding */ java.lang.String, NodeLib.Buffer] with ScalablyTyped.runtime.Instantiable1[(/* str */ java.lang.String) | (/* size */ scala.Double) | (/* size */ StdLib.Uint8Array[js.Object]) | (/* array */ StdLib.Array[js.Any]), NodeLib.Buffer] {
