...
class ContentForPublishTest extends AnyFunSuite with Matchers {
  ...
  val project = SbtProject(
    name         = "sbtprojectname",
    organization = "sbtprojectorg",
    artifactId   = "sbtprojectartifactid_sjs1_2.13",
    ...
    Map(
      Source.FromFolder(InFolder(dummyPath), TsIdent.dummyLibrary) -> PublishedSbtProject(
        SbtProject(
          name         = "depname",
          organization = "deporg",
          artifactId   = "departifactid_sjs1_2.13",
          version      = "depversion",
        )(dummyPath, Map(), None),
      )(null, null, None),
    ),
  ...
  val externalDeps = Set(Dep("externaldeporg", "externaldepartifact", "externaldepversion"))

  test("ivy") {
    val xml = ContentForPublish.ivy(versions, project, publication, externalDeps)
    xml.toString should be(
      """<ivy-module version="2.0" xmlns:e="http://ant.apache.org/ivy/extra">
    <info organisation="sbtprojectorg" module="sbtprojectartifactid_sjs1_2.13" revision="sbtprojectversion"
          status="release" publication="31122020115959">
        <description>
            sbtprojectname
        </description>
    </info>
    ...
    <dependencies>
        <dependency org="org.scala-lang" name="scala-compiler" rev="2.13.1"
                    conf="scala-tool-&gt;default,optional(default)"/>
        <dependency org="org.scala-lang" name="scala-library" rev="2.13.1"
        ...
        <dependency org="com.olvind" name="scalablytyped-runtime_sjs1_2.13" rev="2.1.0"
        ...
        <dependency org="externaldeporg" name="externaldepartifact_sjs1_2.13" rev="externaldepversion"
                    conf="compile-&gt;default(compile)"/>
    </dependencies>
</ivy-module>""")
  }
