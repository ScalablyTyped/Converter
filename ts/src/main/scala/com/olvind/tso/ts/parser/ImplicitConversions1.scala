...
trait ImplicitConversions1 extends ImplicitConversions { self: Parsers =>
  ...
  @inline implicit def flatten6[A, B, C, D, E, F, G](
      g: (A, B, C, D, E, F) => G,
  ): (((((A ~ B) ~ C) ~ D) ~ E) ~ F) => G = {
    case a ~ b ~ c ~ d ~ e ~ f => g(a, b, c, d, e, f)
  }

  @inline implicit def flatten7[A, B, C, D, E, F, G, H](
      h: (A, B, C, D, E, F, G) => H,
  ): (((((A ~ B) ~ C) ~ D) ~ E) ~ F ~ G) => H = {
    case a ~ b ~ c ~ d ~ e ~ f ~ g => h(a, b, c, d, e, f, g)
  }

  @inline implicit def flatten8[A, B, C, D, E, F, G, H, I](
      i: (A, B, C, D, E, F, G, H) => I,
  ): A ~ B ~ C ~ D ~ E ~ F ~ G ~ H => I = {
    case a ~ b ~ c ~ d ~ e ~ f ~ g ~ h => i(a, b, c, d, e, f, g, h)
  }

  @inline implicit def flatten9[A, B, C, D, E, F, G, H, I, J](
